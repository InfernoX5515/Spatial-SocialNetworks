...
class Gui(QtWidgets.QMainWindow):
    ...
    from ._zoom import zoomOutTool
    from ._zoom import zoomInTool

    # functions for shifting the graph
    from ._jog import jogLeftTool
    from ._jog import jogRightTool
    from ._jog import jogUpTool
    from ._jog import jogDownTool
